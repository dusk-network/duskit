<script>
  ...
  export let gap = /** @type {const} */ ("medium");
  export let errorMessage = "Something went wrong";
  export let errorVariant = /** @type {const} */ ("alert");
...
<Suspense {errorMessage} {errorVariant} {gap} {pendingMessage} {waitFor}>
