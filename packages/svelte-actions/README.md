...
[![NPM version](https://img.shields.io/npm/v/@duskit/svelte-actions.svg)](https://www.npmjs.com/package/@duskit/svelte-actions)
...
```bash
npm install @duskit/svelte-actions --save
```
