...
- [#317](https://github.com/dusk-network/duskit/pull/317) [`effbc9b`](https://github.com/dusk-network/duskit/commit/effbc9b87a0bb39aed406019a9224328c4c183e7) Thanks [@ascartabelli](https://github.com/ascartabelli)! - fix(error): preserve name property from `DOMException` and similar error-like objects in `getErrorFrom`

## 0.0.2

### Patch Changes

- [#163](https://github.com/dusk-network/duskit/pull/163) [`91c7505`](https://github.com/dusk-network/duskit/commit/91c75056ab0f15d7e2fe85dff06928c33ba4c9f5) Thanks [@ascartabelli](https://github.com/ascartabelli)! - Added a safety net to `getErrorFrom` in case `JSON.stringify` fails
