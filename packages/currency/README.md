...
[![NPM version](https://img.shields.io/npm/v/@duskit/currency.svg)](https://www.npmjs.com/package/@duskit/currency)

Functions for currency formatting and manipulation.
...
```bash
npm install @duskit/currency --save
```

Import the functions you need:

```js
import { createTransferFormatter } from "@duskit/currency";

const amount = 1_234.56;
const usFormatter = createTransferFormatter("en-US");

usFormatter(amount); // => "+1,234.56"
```
